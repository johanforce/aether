...
package com.jarvis.weatherj.common.utils
...
object NotificationUtils {
    ...
    private fun createNotificationChannel(
        ...
        channel.apply {
            if (channelId == MainApplication.applicationContext().getString(R.string.default_notification_channel)) {
    ...
    fun createNotification(
        ...
        val channelId = MainApplication.applicationContext().getString(R.string.default_notification_channel)
