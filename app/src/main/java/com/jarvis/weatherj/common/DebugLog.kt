...
import com.jarvis.weatherj.common.utils.FileUtils
...
class DebugLog {
    ...
    private val logFolder by lazy {
        FileUtils.folder(MainApplication.applicationContext().filesDir, LOG_FOLDER)
    }
    ...
    private fun appendLogFile(text: Any) {
        val asthmaLog1 =
            File(MainApplication.applicationContext().filesDir, LOG_FILE_NAME + "_1.log")
